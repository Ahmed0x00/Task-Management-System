...
import com.example.taskmanagement.util.CustomerUtil;
...
public class ManageCustomersController {
    ...
    private VBox createCustomerCard(Customer customer) {
        ...
        deleteBtn.setOnAction(e -> {
            CustomerUtil.deleteCustomerById(customer.getId());
            loadCustomers();
        });
    ...
    private void showCustomerDialog(Customer customer, boolean editing) {
        ...
        dialog.showAndWait().ifPresent(result -> {
            if (editing) {
                CustomerUtil.updateCustomer(result);
            } else {
                CustomerUtil.addCustomer(result);
            }
            loadCustomers();
        });
    }
