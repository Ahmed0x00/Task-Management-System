...
public class ManageEmployeeTypesController {
    ...
    private void loadEmployeeTypes() {
        ...
        List<EmployeeType> employeeTypes = EmployeeTypeUtil.getAllEmployeeTypes();
    ...
    private VBox createEmployeeTypeCard(EmployeeType employeeType) {
        ...
        deleteBtn.setOnAction(e -> {
            EmployeeTypeUtil.deleteEmployeeTypeById(employeeType.getId());
            loadEmployeeTypes();
        });
    ...
    private void showEmployeeTypeDialog(EmployeeType employeeType, boolean editing) {
        ...
        dialog.showAndWait().ifPresent(result -> {
            if (editing) {
                EmployeeTypeUtil.updateEmployeeType(result);
            } else {
                EmployeeTypeUtil.addEmployeeType(result);
            }
            loadEmployeeTypes();
        });
    }
