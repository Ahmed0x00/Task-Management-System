...
import com.example.taskmanagement.util.TimeCardUtil;
...
public class ViewTimeCardsController {
    ...
    private void loadAllTimeCards() {
        ...
        timeCardTable.getItems().addAll(FXCollections.observableArrayList(TimeCardUtil.getAllTimeCards()));
    }

    private void loadEmployeeTimeCards(String employeeId) {
        timeCardTable.getItems().clear();
        timeCardTable.getItems().addAll(FXCollections.observableArrayList(TimeCardUtil.getTimeCardsByEmployee(employeeId)));
    }
    ...
    private void handleSubmitTimeCard() {
        ...
        if (TimeCardUtil.addTimeCard(timeCard)) {
