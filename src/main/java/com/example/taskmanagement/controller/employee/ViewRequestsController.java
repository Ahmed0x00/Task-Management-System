...
import com.example.taskmanagement.util.LeaveTypeUtil;
import com.example.taskmanagement.util.RequestUtil;
...
public class ViewRequestsController {
    ...
    public void initialize() {
        ...
        employeeNameColumn.setCellValueFactory(cellData ->
                new SimpleStringProperty(UserUtil.getEmployeeName(cellData.getValue().getEmployeeId())));
        ...
        actionColumn.setCellFactory(col -> new TableCell<>() {
...

            {
                approveButton.setOnAction(event -> {
                    ...
                    if (RequestUtil.updateRequest(request)) {
        ...
        leaveTypeComboBox.setItems(FXCollections.observableArrayList(LeaveTypeUtil.getAllLeaveTypes()));
    ...
    private void loadAllRequests() {
        ...
        requestTable.getItems().addAll(FXCollections.observableArrayList(RequestUtil.getAllRequests()));
    }

    private void loadEmployeeRequests(String employeeId) {
        requestTable.getItems().clear();
        requestTable.getItems().addAll(FXCollections.observableArrayList(RequestUtil.getRequestsByEmployee(employeeId)));
    }
    ...
    private void handleSubmitRequest() {
        ...
        if (RequestUtil.addRequest(request)) {
